...
<pre style="font-weight: bold; font-family: monospace; white-space: pre-wrap; background-color: #717171; border: 2px solid #981e32;">
Personally, I actually found myself enjoying this style of midterm. While I will admit that it took a while and forced me to re-watch some of the previous lectures, I like that I was able to 1.) take my time on it. And 2.) relearn/re-implement some of the things that have been done throughout the semester. I would say that this type of midterm did take longer than other midterms I have done that were "math-related" but I am not personally opposed to that. As long as I have the time, which was provided. Also, I really liked that it was broken down into really tiny chunks so that you could finish one and move on to the next task. It makes it feel more managable than one long problem with multiple parts. Last, I feel like it covered the overall topics of the semester (up to this point) really well. 
</pre>
